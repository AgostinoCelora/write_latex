...
\title{Exploitation of 2D Aluminum GEM detector on MAST-U tokamak }
...
\emailAdd{a.celora@campus.unimib.it}

\abstract{
  Due righ sulla necessità di rad-hard detector su tokamak in ottica di rettore. 
  e dire delle GEM come proposta. Citare caratteristiche delle GEM e dire caratteristiche principali (Ar/CO2, alluminio linea di vista).
  Parlare dei primi risultati (shot ohmici good, con il beam bad per via del background di neutroni) e degli improvements da fare (Neon, linea di vista)
}
